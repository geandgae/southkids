$(document).ready(function(){
    ...
    //  $(".reser_btn").attr({"href":"https://www.ddnayo.com/RsvSys/?id_hotel=2759","target":"_blank"})
     $(".reser_btn").attr({"href":"https://www.yapen.co.kr/external?ypIdx=22806","target":"_blank"})
     $(".insta_link").attr({"href":"https://www.instagram.com/explore/tags/��鍮뚮씪怨듦컙�꾨쭏��","target":"_blank"})
     $(".blog_link").attr({"href":"https://search.naver.com/search.naver?where=post&sm=tab_pge&query=��鍮뚮씪怨듦컙�꾨쭏��","target":"_blank"})
    ...
    const basic_slide_ui = function(){                    
        ...
        const slide_lenght = $(".basic-slide-wrap").find(".swiper-slide").length - 2
        if(slide_lenght < 10){
    ...
    const room_preview_slide = function(){            
        let room_name_var = ["1A","1B","2 PRIVATE","3A","3B","4A","4B","AMARE"]        
        ...
        const slide_lenght = $(".room-preview-slide1").find(".swiper-slide").length - 2
        if(slide_lenght < 10){
            total_txt.text(slide_lenght)
        }else{
            total_txt.text(slide_lenght)
...
//            },  
            ...
            on:{
                slideChangeTransitionEnd: function(){                    
                    const info_txt_wrap = $(".special-preview-section").find(".txt-list-wrap"),                    
                    // �ㅽ럹�� �꾨━酉� 留곹겕 �낅땲��. 留곹겕 �쒖꽌�� �곕씪 link_var 諛곗뿴 �섏젙�댁＜�쒕㈃ �⑸땲��.
    ...
    function tour_scrollMagic(){
        ...
        for(i = 1; i < info_depth.length+1; i++){        
            function setting_magic(){
                var right_eff = TweenMax.to(".tour-info-depth"+i+" .right-info .small-img",0.5,{
                    y : 0
                })                        
                var scene = new ScrollMagic.Scene({    
                ...
                var left_eff = TweenMax.to(".tour-info-depth"+i+" .left-info .big-img",0.5,{
    ...
    function room_scrollMagic(){
        function txt_animation(){
            var rolling_txt = TweenMax.to(".room-wrap .intro-section .img-wrap .svg-tit",0.5,{
                rotation : 120
            })                        
            var scene = new ScrollMagic.Scene({    
            ...
            var slide_txt = TweenMax.to(".room-wrap .intro-section .img-wrap .tit",0.5,{
                x : 0
            })                        
            var scene = new ScrollMagic.Scene({    
                triggerElement: ".intro-section",
        ...
        function preview_img_animation(){
            var left_img = TweenMax.to(".room-wrap .room-nav-section .img-wrap.img-left .img-box",0.5,{
                y : 0
            })                        
            var scene = new ScrollMagic.Scene({    
            ...
            var right_img = TweenMax.to(".room-wrap .room-nav-section .img-wrap.img-right .img-box",0.5,{
                y : 0
            })                        
            var scene = new ScrollMagic.Scene({    
                triggerElement: ".room-nav-section",
    ...
    function special_scrollMagic(){
        function rooling_scroll(){
            var rolling_txt = TweenMax.to(".special-wrap .info-section .img-wrap.img-right",0.5,{
                y : $(".special-wrap .info-section .img-wrap.img-right").innerHeight()/3
            })                        
            var scene = new ScrollMagic.Scene({    
    ...
    function reser_scrollMagic(){
        function view_img2(){
            let item_arr = [
                img1 = {
                    target : ".reser-wrap .intro-section .img-wrap .img1", // ��寃�
                    move_y : "-50", // �대룞�� y媛�
                    trigger : ".reser-wrap .intro-section .img-wrap", //�쒖옉�� ��寃�                
                    move_duration : $(window).height() // �대룞�� 踰붿쐞
                },
                img2 = {
                    target : ".reser-wrap .intro-section .img-wrap .img2", // ��寃�
                    move_y : "20", // �대룞�� y媛�
                    trigger : ".reser-wrap .intro-section .img-wrap", //�쒖옉�� ��寃�                
                    move_duration : $(window).height(), // �대룞�� 踰붿쐞                
                },
                img3 = {
                    target : ".reser-wrap .intro-section .img-wrap .img3", // ��寃�
                    move_y : "-15", // �대룞�� y媛�
                    trigger : ".reser-wrap .intro-section .img-wrap", //�쒖옉�� ��寃�                
                    move_duration : $(window).height(), // �대룞�� 踰붿쐞                
                },                 

  ...
  (function () {
    ...
    var ui = {
      ...
      debug: {
        ...
        set: function () {
          ...
          $("#debug").html(
            "SCT : " + sct + " ,SCR : " + scr + " , DOCH : " + docH + " , visualViewport : " + wHt + "  , iosX :  " + JSON.stringify(ui.getSafe)
          );
        },
      },
      caption: {
        // 테이블 th 내용으로 캡션문구 만들기
        init: function () {
          this.evt();
          setTimeout(() => {
            this.set();
      ...
      cm: {
        ...
        init: function () {
          window.addEventListener("resize", () => {
            document.querySelector(":root").style.setProperty("--vh", window.innerHeight / 100 + "rem");
          });
        },
      },
      tbl: {
        // 테이블 스크롤 고정   /guide/test.html
        init: function () {
          this.set();
        },
        set: function () {
          $(".ut-tbl.fixed-x").each(function () {
            ...
            $(this)
              .find(".tbl-dumy")
              .css("width", fixWidth + "rem");
            $(this)
              .find(".tbl-real .tbl-screen")
              .css("width", fixWidth + "rem");
      ...
      prd: {
        // /mo/html/prd/UI-PPRINPD6121MS.html
      },
      isUA: function (t) {
        // 디바이스 구분
        t = t.split(" ");
      ...
      ly: {
        ...
        set: function () {
          if ($("#container:visible").length) {
            var cls = $("#container:visible")
              .attr("class")
              .replace(/container|page/g, "");
            $("body").addClass(cls);
          }
        ...
        floating: {
          ...
          evt: function () {
            ...
            $(document).on("click", ".quicknav .xbox", function () {
        ...
        botnav: {
          ...
          init_old: function () {
            ...
            $(window).on("load pageshow scroll", function (e) {
              // 스크롤 내리는 중 OR 올리는중
          ...
          init: function () {
            ...
            document.addEventListener("scroll", (e) => {
              ...
              if (ui.viewport.scrollTop() > 1) {
                $("body").addClass("is-head-shadow");
                if (native.isApp() == true && _nowPageCd === "DTMCONLNLM001" && !_USER.isLogin) {
                  $("body").removeClass("hstyle");
                }
              } else {
                $("body").removeClass("is-head-shadow");
                if (native.isApp() == true && _nowPageCd === "DTMCONLNLM001" && !_USER.isLogin) {
                  $("body").addClass("hstyle");
                }
              }
            });
          },
      ...
      fsize: {
        ...
        evt: function () {
          var _this = this;
          $(document)
            .on("click", "[data-ui-fsize='btn']", function (e) {
              var $myui = $(this);
              if ($myui.is(".open")) {
                _this.close($myui);
              } else {
        ...
        open: function (els) {
          ...
          $("[data-ui-fsize='pop'] button[value='" + fsize + "']")
            .closest("li")
            .addClass("active")
            .siblings("li")
            .removeClass("active");
      ...
      tooltip: {
        ...
        evt: function () {
          var _this = this;
          $(document)
            .on("click", ".ut-tooltip .bt-tooltip:not([aria-labelledby])", function (e) {
      ...
      toolpop: {
        ...
        open: function (id) {
          ...
          $(".ut-tooltip").removeClass("open");
          var pop =
            '<article class="pop-layer b pop-tooltip ut-tooltip" id="' +
            id +
            '">' +
            '	<div class="pbd">' +
            '		<div class="phd blind">' +
            ...
            "		</div>" +
            '		<div class="pct">' +
            '			<main class="poptents"><div class="toolctn">' +
            this.html +
            "</div></main>" +
            "		</div>" +
      ...
      balloon: {
        ...
        set: function () {
          $("[data-ui-balloon]").each(function () {
            ...
            $ball.addClass(cls);
            var box = '<div class="ball">' + '	<span class="msg">' + msg + "</span>" + '	<button type="button" class="close">말풍선닫기</button>' + "</div>";
      ...
      range: {
        ...
        set: function () {
          $(".ut-barslide.a").each(function () {
            var $this = $(this);
            !$this.find(".ui-slider-handle").length &&
              $this.find(".barslide").append('<div class="ui-slider-handle"><span class="hantxt"></span></div><em class="bar"></em>');
      ...
      form: {
        ...
        select: {
          ...
          open: function (els) {
            ...
            for (var i in list) {
              if (list[i].o == true) {
                blist +=
                  '<li><button type="button" class="bt" value="' +
                  list[i].v +
                  '" disabled="true" style="color:grey">' +
                  list[i].t +
                  '<i class="blind">선택하기</i></button></li>';
              } else {
            ...
            $(els)
              .closest(".select")
              .find(".slist")
              .css("min-width", btnWidth - 4);
            $(els)
              .closest(".select")
              .find(".slist button[value='" + sel + "']")
              .attr("title", "선택됨")
              .closest("li")
              .addClass("active")
              .siblings("li")
        ...
        intdel: {
          ...
          xpadd: function (els) {
            ...
            //2022-04-28 예외처리
            $(els)
              .closest(".input:not(.ipsch)")
              .find(">input")
              .css({ "padding-right": _this.posit(els) });
            $(els)
              .closest(".input:not(.ipsch)")
              .find(".btdel")
              .show()
              .css({ right: _this.posit(els) });
          },
          xshow: function (els) {
      ...
      togs: {
        ...
        evt: function () {
          var _this = this;
          $(document).on("click", "[data-tog-cls='btn'],[data-tog-cls='txt']", function (e) {
            //[data-tog-cls='txt']추가_2023_0302
              ...
              $ctn.slideDown(100, function () {
                ...
                if ($box.hasClass("ut-gudbox")) {
                  ...
                  if (isPop)
                    $("pct")
                      .css("overflow-y", "auto")
                      .animate({ scrollTop: popScrTop - ctnH }, 500);
      ...
      tog: {
        ...
        open: function (id) {
          $("[data-ui-tog='btn'][data-ui-tog-val='" + id + "']")
            .addClass("open")
      ...
      datepick: {
        ...
        set: function (params) {
          ...
          if (this.opts.id) {
            $("#" + this.opts.id + ":not([disabled]):not([readonly])")
        ...
        setYY: function (els, id) {
          ...
          var btsy =
            '<div class="btsy">' + '<button class="bt prev" type="button">이전</button>' + '<button class="bt next" type="button">다음</button>' + "</div>";
      ...
      monthpick: {
        ...
        setm: function (id) {
          ...
          $(".ut-pop-month .lst[data-yy='" + current.yy + "'] li .mt[data-val='" + current.mm + "']")
            .closest("li")
            .addClass("active");
        ...
        pop:
          '<article class="pop-layer c pop-month ut-pop-month" id="pop-month">' +
          '	<div class="pbd">' +
          '		<div class="phd">' +
          '			<div class="in">' +
      ...
      lock: {
        ...
        using: function (opt) {
          if (opt === true && this.stat === false) {
            ...
            $(this.els).bind("touchmove scroll", function (e) {
              e.preventDefault();
            });
          }
      ...
      alert: function (msg, params) {
        ...
        var lyAlert =
          '<article aria-live="assertive" class="ui-alert ' +
          opt.cls +
          '">' +
          '	<div class="pbd" tabindex="0">' +
          '		<div class="phd"><span class="tit">' +
          opt.tit +
          "</span></div>" +
          '		<div class="pct"><div class="msg">' +
          opt.msg +
          "</div></div>" +
          '		<div class="pbt">' +
      ...
      confirm: function (msg, params) {
        ...
        var lyConfirm =
          '<article aria-live="assertive" class="ui-confrim ' +
          opt.cls +
          '">' +
          '	<div class="pbd" tabindex="0">' +
          '		<div class="phd"><span class="tit">' +
      ...
      toast: function (msg, params) {
        ...
        if ($(".pop-toast:visible").length) {
          return;
        }

        var lyToast =
          '<article role="alert" aria-live="assertive" class="pop-toast ' +
          _this.opt.cls +
          '">' +
          '	<div class="pbd">' +
          '		<div class="pct">' +
      ...
      popup: {
        ...
        callbacks: {},
        bottomUpSheetIds: ["pop-app-interest", "pop-dti1693", "pop-dti1694", "gnb", "pop-notice-stfu", "sys-error-notice"],
        open: function (id, params) {
          if (
            (ui.popup.bottomUpSheetIds.indexOf(id) > -1 || id.indexOf("pop-notice-evt") === 0) &&
            _nowPageCd === "DTMCONLNLM001" &&
            localStorage.getItem("main.bottom.myDeck") !== null &&
            localStorage.getItem("main.bottom.myDeck") !== ""
          ) {
          ...
          $("#" + id)
            ...
            .addClass(_this.opt.direct)
            .css({ zIndex: cntZindex })
            .fadeIn(10, function () {
        ...
        close: function (id, params) {
          ...
          // }
          if (
            ui.popup.bottomUpSheetIds.indexOf(id) > -1 &&
            _nowPageCd === "DTMCONLNLM001" &&
            localStorage.getItem("main.bottom.myDeck") !== null &&
            localStorage.getItem("main.bottom.myDeck") !== ""
          ) {
        ...
        resize: function () {
          $(".pop-layer:visible").each(function () {
            ...
            pctnH = pctnH - (phdH || 0);
            if ($pop.is(".a")) {
              $pop.find(".pbd>div.pct").css({ height: pctnH });
            }
            if ($pop.is(".b")) {
              $pop.find(".pbd>div.pct").css({ "max-height": pctnH - pbtnH - 40 });
            }
            if ($pop.is(".c")) {
              // 2022-16-17 높이체크 안함
            ...
            if ($pop.find(".pbt:visible").length || $pop.find(".floatbots>.inr:visible").length) {
              ...
              $pop
                .filter(".a,.c")
                .find(".pct")
                .css({ "padding-bottom": "calc(" + pdBottom + "rem + env(safe-area-inset-bottom))" });
            } else {
              $("body").removeClass("is-pop-pbt");
      ...
      wacc: {
        ...
        set: function () {
          ...
          acc_term.forEach(function (item) {
            ...
            if (!link == "") {
              if (
                link.classList.contains("plink") ||
                link.classList.contains("plink2") ||
                link.classList.contains("plinks") ||
                link.classList.contains("plinks-fnno")
              ) {
    ...
    $(document).ready(function () {
      ...
      if (typeof ui.html.set == "undefined") {
        ...
        ui.html.include();
        ui.html.times = setInterval(function () {
          // console.log("ui.html" ,  ui.html.incCom);
          if (ui.html.incCom) {
